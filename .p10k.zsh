# Generated by Powerlevel10k configuration wizard on 2025-02-27 at 17:10 EST.
...
# 12h time, 2 lines, solid, left frame, black-ornaments, compact, many icons, concise,
...
() {
  ...
  # NEW
  prompt_user_host() {
    p10k segment -t "%F{#e5c084}${USER}%f%F{blue}@%f%F{#e5c084}${HOST%%.*}%f" #blue fits the current theme, (DoomOne)
    #"${USER}@${HOST%%.*}"
  }
